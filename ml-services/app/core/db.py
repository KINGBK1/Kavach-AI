    ...
    for attempt in range(5):
        try:
            with get_conn() as conn:
                ...
                cur.execute("CREATE INDEX IF NOT EXISTS idx_incidents_source ON incidents(source)")
                ...
                cur.execute("CREATE INDEX IF NOT EXISTS idx_analysis_history_incident_id ON analysis_history(incident_id)")
                cur.execute("CREATE INDEX IF NOT EXISTS idx_analyses_priority_score ON analyses(priority_score)")
